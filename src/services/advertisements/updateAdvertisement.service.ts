...
import { TAdvertisementUpdateRequest, TupdateAdvertisement } from "../../interfaces/advertisement.interface";
...
const updateAdvertisementService = async (
  ...
  const oldAdvertisement: Advertisement | null = await AdvertisementRepository.findOneBy({
    id: advertisementId,
  });
