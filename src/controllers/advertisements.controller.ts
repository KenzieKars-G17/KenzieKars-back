...
const createAdvertisementController = async (req: Request, res: Response): Promise<Response>  => {
  ...
  const listAdvertisementsByIdController = async (req: Request, res: Response) => {
  ...
  const updateAdvertisementController = async (req: Request, res: Response) => {
    ...
    const updateContact = await updateAdvertisementService(updateData, advertisementId);
...
export {createAdvertisementController, listAdvertisementsByIdController,updateAdvertisementController,deleteAdvertisementController}